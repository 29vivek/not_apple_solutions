...
const Widget verticalSpaceExtraSmall = SizedBox(height: 8.0);
const Widget verticalSpaceSmall = SizedBox(height: 10.0);
const Widget verticalSpaceSmallMedium = SizedBox(height: 12.0);
...
Widget extraSmallBottomSpacedDivider = Column(
  children: const <Widget>[
    const Divider(height: 5.0),
...
Widget smallMediumSpacedDivider = Column(
  children: const <Widget>[
    verticalSpaceSmallMedium,
    const Divider(height: 5.0),
    verticalSpaceSmallMedium,
...
Widget virginDivider = const Divider(height: 5.0);
